...
export function SettingsPanel({ bridgeConnected }: SettingsPanelProps) {
  ...
  return (
    <div className="registry-secondary-page max-w-3xl">
      ...
      <div className="flex flex-col gap-6">
        <div className="registry-card">
          <h3 className="registry-card-label">Interface Preferences</h3>
          <div className="registry-settings-row">
        ...
        <div className="registry-card">
          <h3 className="registry-card-label">Extension Connectivity</h3>
          <div className="flex flex-col">
            <div className="registry-settings-row border-b border-slate-100 dark:border-slate-800/60">
              <div className="flex-1">
        ...
        <div className="registry-card">
          <h3 className="registry-card-label">Developer & System Actions</h3>
          <div className="registry-settings-row">
            <div className="flex-1">
